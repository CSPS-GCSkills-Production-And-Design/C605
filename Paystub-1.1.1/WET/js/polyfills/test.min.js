 ...
 */
!(function (a, b) {
  (Modernizr.inputtypes.date ? describe.skip : describe)(
    ...
    function () {
      ...
      before(function () {
        i.on("wb-init.wb-date", "input[type=date]", function () {
          (d = a(k)), g && g();
        });
      }),
        ...
        describe("with a date format and error in the label", function () {
          before(
            l(
              null,
              '<label for="appointment"><span class="field-name">Appointment Date</span><span class="datepicker-format">(YYYY-MM-DD)</span><b class="error" id="appointment-error"><span class="label label-danger"><span class="prefix">Error 1: </span>Please enter a valid date</span></b></label>'
            )
          ),
            after(m),
        ...
        describe("with a populated date", function () {
          before(l('<input type="date" id="appointment" value="2014-08-07"/>')),
            after(m),
            it("should have stored the date in the state object", function () {
              var a = e.get(0).state;
              expect(a.date.toString()).to.equal(
                new Date(2014, 7, 7).toString()
              );
            });
        }),
        ...
        describe("toggle button for disabled date field", function () {
          before(function (a) {
            (g = function () {
              e.next().find("a").click(), a();
            }),
              l('<input type="date" readonly id="appointment"/>')();
          }),
            after(function () {
              e.next().find("a").click(), m();
            }),
        ...
        describe("close button", function () {
          before(function (b) {
            (g = function () {
              e.next().find("a").click(), a(".picker-close").click(), b();
            }),
              l('<input type="date" id="appointment"/>')();
          }),
            after(m),
        ...
        describe("minimum date", function () {
          before(function (b) {
            (g = function () {
              e.next().find("a").click(),
                a(".cal-year").val(2014).trigger("change"),
                a(".cal-month").val(2).trigger("change"),
                b();
            }),
              l('<input type="date" id="appointment" min="2014-03-18"/>')();
          }),
            after(function () {
              e.next().find("a").click(), m();
            }),
        ...
        describe("maximum date", function () {
          before(function (b) {
            (g = function () {
              ...
              l('<input type="date" id="appointment" max="2014-03-18"/>')();
          }),
            after(function () {
              e.next().find("a").click(), m();
            }),
        ...
        describe("minimum and maximum dates in same month", function () {
          before(function (a) {
            ...
            it("should have prevented the creation of links before the minimum date and past the maximum date", function () {
              expect(a(k).find(".cal-days a").length).to.equal(15);
            });
        }),
        ...
        describe("updating the min and max date of the field after the creation of the element", function () {
          before(function (a) {
            ...
            it("should have update the min and max date of the date picker", function () {
              expect(a(k).find(".cal-days a").length).to.equal(6);
            });
        });
    }
  );
